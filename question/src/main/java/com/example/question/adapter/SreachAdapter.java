 ...
 * <p>创建时间：2019/7/11<p>
 */
public class SreachAdapter extends RecyclerView.Adapter<SreachAdapter.MyViewHolder> {

    private Context mContext;
    private List<SreachBean.ResultBean> arr = new ArrayList<>();

    public SreachAdapter(Context mContext) {
        this.mContext = mContext;
    }

    public void setList(List<SreachBean.ResultBean> list) {
        if (list != null) {
            arr.clear();
            arr.addAll(list);
